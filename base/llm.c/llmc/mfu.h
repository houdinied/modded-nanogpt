...
// B200: 168 SMs, 4 TCs/SM = 672 TCs, dense BF16 ~1125 TFlops at base
static const PerfData BLACKWELL = {562.f, 1125.f, 1125.f, 2250.f, 2250.f, 4500.f, 1965.f, 672.f};
...
static GPUEntry gpu_db[] = {
    ...
    {"NVIDIA B200", &BLACKWELL, 672, 1965},
};
